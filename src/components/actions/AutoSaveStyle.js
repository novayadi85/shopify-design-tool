...
class AutoSaveStyle extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    // submitting state.
    return (
      this.state.submitting && <div className="submitting"></div>
    )
  }
}
...
export default props => (
  <FormSpy {...props} subscription={{ values: true }} component={AutoSaveStyle} />
)
